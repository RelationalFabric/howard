...
void invariant<Expect<EagerResult<string>, ConditionalInterface<string>>>()
...
void invariant<Expect<LazyResult<string>, ConditionalInterface<string>>>()
...
void invariant<Expect<ConditionalIsCallable, boolean>>()
...
void invariant<Expect<ConditionalAndResult<string, number>, ConditionalInterface<string & number>>>()
...
void invariant<Expect<ConditionalOrResult<string, number>, ConditionalInterface<string | number>>>()

// AnyCondition should be ConditionInterface<unknown>
void invariant<Expect<AnyCondition, ConditionInterface<unknown>>>()
void invariant<Expect<ConditionInterface<unknown>, AnyCondition>>()

// AnyConditional should be ConditionalInterface<unknown>
void invariant<Expect<AnyConditional, ConditionalInterface<unknown>>>()
void invariant<Expect<ConditionalInterface<unknown>, AnyConditional>>()

// ConditionInterface should be covariant in T
void invariant<Expect<ConditionInterface<string>, ConditionInterface<string | number>>>()

// ConditionalInterface should be covariant in T
void invariant<Expect<ConditionalInterface<string>, ConditionalInterface<string | number>>>()
